export const EducationCard = ({
  ...
  <div className="flex flex-col gap-2 w-full  md:w-7/12 p-4 md:p-6 rounded-lg cursor-pointer relative bg-blue-50 dark:bg-neutral-900  hover:bg-blue-100 dark:hover:bg-neutral-800 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]">
