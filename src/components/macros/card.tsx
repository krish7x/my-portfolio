export const Card = ({ yrsOfExp, company, location, description }: { yrsOfExp: string, company: string, location: string, description: string }) => (
  <div className="flex flex-col gap-2 w-full md:w-9/12 p-4 md:p-6 bg-stone-200 rounded-lg  hover:bg-stone-300 dark:bg-neutral-900 dark:border-gray-700 dark:hover:bg-neutral-800 cursor-pointer relative border   ring-1 ring-white/10 shadow-[0_20px_207px_rgba(238,_130,_238,_0.2)]">
