...
>
  <img
    ...
    class="m-auto w-[calc(300px)] cursor-zoom-in"
  />
</a>
...
>
  <img
    ...
    alt="cl-survey-page"
    class="m-auto h-auto w-[calc(300px)] cursor-zoom-in"
  />
</a>
...
A huge shout-out to my amazing hackathon team — **Sudhagar**, **Ashwin**, **Parthiban**, and **Ritesh** for their dedication and hard work. And once again special thanks to Sudhagar and Parthiban for their stellar efforts in building the **MVP**.
...
**Next Up:** I will be writing a separate post for **Report pagination table** implementation and **download CSV Reports** using **asynchronous API** and **Node.js worker**, which will be coming soon. Stay tuned 🚀
